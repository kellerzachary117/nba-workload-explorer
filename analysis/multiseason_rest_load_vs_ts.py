"""
Replicates rest_load_vs_ts_zscore.py across every season in data_utils.AVAILABLE_SEASONS,
to check whether the "no detectable rest/workload effect" finding from 2023-24 holds up
in other seasons or was specific to that one.
"""
import glob
import math
